...
with open('script/text.txt', 'w') as file:
...
with open('script/command.json', 'w') as t_json:
    t_json.write(text)

with open('script/command.json', 'r') as input_file:
                    ...
                    for x in range(len(comandos)):
                            ...
                            for i in range(len(comman)):
                                if(i > 0):
                                    ...
                                    print("\nAtalhos:")
                    print("\n")
                    print("Pressione qualquer tecla e depois Enter para finalizar")
                    input()
